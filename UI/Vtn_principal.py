...
class Ui_VTNWindow(object):
    def setupUi(self, VTNWindow):
        ...
        self.btn_Grabar.setGeometry(QRect(130, 330, 81, 21))
        ...
        self.btn_estatura.setGeometry(QRect(180, 240, 81, 21))
        ...
        self.btn_peso = QPushButton(self.centralwidet)
        self.btn_peso.setObjectName(u"btn_peso")
        self.btn_peso.setGeometry(QRect(180, 270, 81, 21))
        ...
        self.mnb_menu_principal.setGeometry(QRect(0, 0, 476, 21))
    ...
    def retranslateUi(self, VTNWindow):
        ...
        self.btn_peso.setText(QCoreApplication.translate("VTNWindow", u"E. D. Peso", None))
